...
func WithOrganizationByID(organizationID *mbuserdomain.OrganizationID) OrganizationActionOption {
	return func(ctx context.Context, action *organizationAction) error {
...
func WithOrganizationByName(organizationName string) OrganizationActionOption {
	return func(ctx context.Context, action *organizationAction) error {
