...
// NewMockCocotolaCoreCallbackClient creates a new instance of MockCocotolaCoreCallbackClient. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockCocotolaCoreCallbackClient(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockCocotolaCoreCallbackClient {
	mock := &MockCocotolaCoreCallbackClient{}
	mock.Mock.Test(t)
...
// MockCocotolaCoreCallbackClient is an autogenerated mock type for the CocotolaCoreCallbackClient type
type MockCocotolaCoreCallbackClient struct {
	mock.Mock
}

type MockCocotolaCoreCallbackClient_Expecter struct {
	mock *mock.Mock
}

func (_m *MockCocotolaCoreCallbackClient) EXPECT() *MockCocotolaCoreCallbackClient_Expecter {
	return &MockCocotolaCoreCallbackClient_Expecter{mock: &_m.Mock}
}

// OnAddUserSpace provides a mock function for the type MockCocotolaCoreCallbackClient
func (_mock *MockCocotolaCoreCallbackClient) OnAddUserSpace(ctx context.Context, organizationID *domain.OrganizationID, userID *domain.UserID, spaceID *domain.SpaceID) error {
	ret := _mock.Called(ctx, organizationID, userID, spaceID)

	if len(ret) == 0 {
		panic("no return value specified for OnAddUserSpace")
	}

	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, *domain.OrganizationID, *domain.UserID, *domain.SpaceID) error); ok {
		r0 = returnFunc(ctx, organizationID, userID, spaceID)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// MockCocotolaCoreCallbackClient_OnAddUserSpace_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'OnAddUserSpace'
type MockCocotolaCoreCallbackClient_OnAddUserSpace_Call struct {
	*mock.Call
}

// OnAddUserSpace is a helper method to define mock.On call
//   - ctx
//   - organizationID
//   - userID
//   - spaceID
func (_e *MockCocotolaCoreCallbackClient_Expecter) OnAddUserSpace(ctx interface{}, organizationID interface{}, userID interface{}, spaceID interface{}) *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call {
	return &MockCocotolaCoreCallbackClient_OnAddUserSpace_Call{Call: _e.mock.On("OnAddUserSpace", ctx, organizationID, userID, spaceID)}
}

func (_c *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call) Run(run func(ctx context.Context, organizationID *domain.OrganizationID, userID *domain.UserID, spaceID *domain.SpaceID)) *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*domain.OrganizationID), args[2].(*domain.UserID), args[3].(*domain.SpaceID))
	})
	return _c
}

func (_c *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call) Return(err error) *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call) RunAndReturn(run func(ctx context.Context, organizationID *domain.OrganizationID, userID *domain.UserID, spaceID *domain.SpaceID) error) *MockCocotolaCoreCallbackClient_OnAddUserSpace_Call {
	_c.Call.Return(run)
	return _c
}
