...
func GetUserInfo(ctx context.Context, systemToken libdomain.SystemToken, authTokenManager AuthTokenManager, nonTxManager mbuserservice.TransactionManager, bearerToken string) (*mbuserdomain.UserModel, error) {
	...
	userModel, err := mblibservice.Do1(ctx, nonTxManager, func(rf mbuserservice.RepositoryFactory) (*mbuserdomain.UserModel, error) {
