module github.com/mocoarow/cocotola-1.24/cocotola-empty

go 1.24.0

require (
	github.com/mocoarow/cocotola-1.24/lib v0.0.0-20250216123417-f55168414267
	github.com/mocoarow/cocotola-1.24/moonbeam v0.0.0-20250216123417-f55168414267
